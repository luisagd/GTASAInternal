...
auto b = sizeof(CPed); // must be 1988U
...
auto a = sizeof(CPedPoolInfo);
//class CMenu
//{
//public:
//    char pad_0000[36]; //0x0000
//    uint32_t RadarMode; //0x0024
//    char pad_0028[44]; //0x0028
//    int32_t SelectedItem; //0x0054
//    char pad_0058[4]; //0x0058
//    int8_t IsMenuActive; //0x005C
//    char pad_005D[7]; //0x005D
//    float MapZoom; //0x0064
//    float MapX; //0x0068
//    float MapY; //0x006C
//    char pad_0070[20]; //0x0070
//    uint32_t Lenguage; //0x0084
//    char pad_0088[212]; //0x0088
//    int8_t N00000894; //0x015C
//    uint8_t Id; //0x015D
//    char pad_015E[1]; //0x015E
//    uint8_t Savegame; //0x015F
//    char pad_0160[1581]; //0x0160
//    uint8_t ShowItemhover; //0x078D
//}; //Size: 0x078E
